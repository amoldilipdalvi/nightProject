...
<body>   
  <div id="wrapper">        
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">                            
                                    ...
                                    <div class="hidden">
                                    <input type="text" id="oppsTotal" value="${bracnhes.oppsTotal}" />
   									<input type="text" id="branchesTotal" value="${bracnhes.brTotal}" />
   									</div>
	...
	<th>Updated By</th> -->
                                            ...
                                            <tbody>
                                              <c:forEach var="sf" items="${bracnhes.subRegions}">   
   <tr id="${sf.brId}">
   <td>
...
<script type="text/javascript">
	$(function(){
        ...
        $('#container').highcharts({
            ...
            xAxis: {
                categories: ["Branches", "Opportunities"]
            },
            series: [{
