...
<body>   
  <div id="wrapper">        
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">                                
                                ...
                                <button class="btn btn-primary btn-sm pull-right btn_margin" onclick="goToBranch()">Go to Branches</button> 
                                <a href="Forecast.html" class="btn btn-primary btn-sm pull-right btn_margin">Forecast</a>
                            ...
                            <div class="panel-body">                            
                                    ...
                                    <div class="hidden">
                                    <input type="text" id="oppsTotal" value="${salesForcasts.oppsTotal}" />
   									<input type="text" id="branchesTotal" value="${salesForcasts.brTotal}" />
   									</div>
	...
	<th>Updated By</th>                                                  
                                            ...
                                            <tbody>
                                              <c:forEach var="sf" items="${salesForcasts.subRegions}">   
   <tr id="${sf.regId}">
   <td>
